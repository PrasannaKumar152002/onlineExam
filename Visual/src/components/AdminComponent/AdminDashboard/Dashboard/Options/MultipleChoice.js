          ...
          <div className="col-6 row mt-3 d-flex align-items-center justify-content-center">
            ...
            <div className="col-auto">
              <textarea
                ...
                defaultValue={props.changedoptionA?props.changedoptionA:props.optionA}
          ...
          <div className="col-6 row mt-3 ms-3 d-flex align-items-center justify-content-center">
            ...
            <div className="col-auto">
              <textarea
                ...
                name="optionB"
                className="form-control mx-sm-5"
                defaultValue={props.changedoptionB?props.changedoptionB:props.optionB}
          ...
          <div className="col-6 row mt-3 d-flex align-items-center justify-content-center">
            ...
            <div className="col-auto">
              <textarea
                ...
                name="optionC"
                className="form-control mx-sm-5"
                defaultValue={props.changedoptionC?props.changedoptionC:props.optionC}
          ...
          <div className="col-6 row mt-3 ms-3 d-flex align-items-center justify-content-center">
            ...
            <div className="col-auto">
              <textarea
                ...
                name="optionD"
                className="form-control mx-sm-5"
                defaultValue={props.changedoptionD?props.changedoptionD:props.optionD}
          ...
          <div className="col-6 row mt-3 d-flex align-items-center justify-content-center">
            ...
            <div className="col-auto">
              <textarea
                ...
                name="optionE"
                className="form-control mx-sm-5"
                defaultValue={props.changedoptionE?props.changedoptionE:props.optionE}
